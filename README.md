...
\`\`\`env
# 社區 A 的 Supabase 設定
NEXT_PUBLIC_NEXT_PUBLIC_TENANT_A_SUPABASE_URL=your_NEXT_PUBLIC_TENANT_A_SUPABASE_URL
NEXT_PUBLIC_NEXT_PUBLIC_TENANT_A_SUPABASE_ANON_KEY=your_tenant_a_anon_key

# 社區 B 的 Supabase 設定
NEXT_PUBLIC_NEXT_PUBLIC_TENANT_B_SUPABASE_URL=your_NEXT_PUBLIC_TENANT_B_SUPABASE_URL
NEXT_PUBLIC_NEXT_PUBLIC_TENANT_B_SUPABASE_ANON_KEY=your_tenant_b_anon_key
\`\`\`
