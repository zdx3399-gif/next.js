      ...
      <div className="bg-[var(--theme-bg-secondary)] border-2 border-blue-500/30 rounded-xl p-5">
        ...
        <div className="space-y-3">
          {reservedVisitors.length > 0 ? (
            ...
            <div className="text-center text-[var(--theme-text-muted)] py-6">目前沒有預約訪客</div>
          )}
        </div>
      </div>
      ...
      <div className="bg-[var(--theme-bg-secondary)] border-2 border-yellow-500/30 rounded-xl p-5">
        ...
        <div className="space-y-3">
          {checkedInVisitors.length > 0 ? (
            ...
            <div className="text-center text-[var(--theme-text-muted)] py-6">目前沒有訪客</div>
          )}
        </div>
      </div>
      ...
      <div className="bg-[var(--theme-bg-secondary)] border-2 border-green-500/30 rounded-xl p-5">
        ...
        <div className="space-y-3">
          {historyVisitors.length > 0 ? (
            ...
            <div className="text-center text-[var(--theme-text-muted)] py-6">目前沒有訪客歷史</div>
          )}
        </div>
      </div>
    </div>
