      ...
      if (event.type === 'postback') {
        ...
        if ((action === 'approve' || action === 'reject') && emergencyEventId) {
          try {
            ...
            console.log(`[BOT1] [緊急審核] Guard 檢查: rawStatus=${JSON.stringify(emergencyEvent.status)} normalizedStatus=${normalizedStatus} guardBlock=${normalizedStatus !== 'pending' && normalizedStatus !== 'draft'}`);
