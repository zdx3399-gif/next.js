            ...
            <div className="bg-[rgba(45,45,45,0.85)] border border-[rgba(255,215,0,0.25)] rounded-2xl p-3 sm:p-6">
              <div className="flex flex-wrap gap-3 mb-4">
                ...
                <button
                    ...
                    "
                  >
                    <span className="material-icons text-lg sm:text-xl">sync</span>
                                  ...
                                  <td className="p-3 border-b border-white/5">
                                      <div className="flex gap-2">
                                        ...
                                        <button
                                          ...
                                          className="w-10 h-10 flex items-center justify-center bg-gray-700 text-white rounded-lg hover:bg-gray-600 transition-all"
                                          title="編輯/儲存"
                                        >
                                          <svg
