          ...
          <div className="bg-[var(--theme-bg-card)] rounded-2xl w-full max-w-sm shadow-2xl overflow-hidden">
            ...
            <div className="p-5 space-y-3">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full px-4 py-3 rounded-xl font-semibold bg-red-500/20 border border-red-500 text-red-600 hover:bg-red-500/30 transition-colors disabled:opacity-50"
              >
                ✓ 正式傳送
