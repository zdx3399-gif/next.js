    ...
    <div className="bg-[var(--theme-bg-card)] border border-[var(--theme-border-accent)] rounded-2xl p-5">
      <div className="flex justify-between items-center mb-5">
        <h2 className="flex gap-2 items-center text-[var(--theme-accent)] text-xl">
          ...
          個人資料
          <HelpHint title="住戶端個人資料" description="可更新姓名、電話、Email 與密碼，房號由系統管理。" />
        </h2>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
        <div>
          <label className="block text-[var(--theme-text-primary)] mb-2 flex items-center gap-2">姓名<HelpHint title="住戶端姓名" description="請填寫可聯絡與辨識的姓名。" align="center" /></label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-[var(--theme-text-primary)] mb-2 flex items-center gap-2">房號<HelpHint title="住戶端房號" description="房號為系統綁定欄位，需由管理端調整。" align="center" /></label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-[var(--theme-text-primary)] mb-2 flex items-center gap-2">電話<HelpHint title="住戶端電話" description="用於緊急聯繫與通知，請保持最新。" align="center" /></label>
          <input
            type="tel"
        ...
        <div>
          <label className="block text-[var(--theme-text-primary)] mb-2 flex items-center gap-2">Email<HelpHint title="住戶端 Email" description="用於接收重要通知與帳號相關訊息。" align="center" /></label>
          <input
            type="email"
        ...
        <div>
          <label className="block text-[var(--theme-text-primary)] mb-2 flex items-center gap-2">新密碼（留空則不修改）<HelpHint title="住戶端密碼更新" description="僅在需要更改時填寫，留空代表維持原密碼。" align="center" /></label>
          <input
            type="password"
